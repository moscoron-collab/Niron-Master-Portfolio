...
function dashboardKnowledge() {
  return '=== DASHBOARD REFERENCE KNOWLEDGE ===\n'
    ...
    + '  - Insurance: full State Farm policy $34,630/yr ($2,885.83/mo) across 13 units, but Divando net cashflow uses the Divando-OWNED share only = $29,677/yr ($2,473.08/mo); the difference is the Dorado-owned units on the policy -- 2397 Jamaica St (Dorado reimburses $67.40/mo as of Aug 29, 2026) and 4641 Enid Way (SOLD Aug 28, 2026, still on the policy pending removal). Agent Kevin Schult (303) 989-3847; renews Dec 15, 2026.\n'
    ...
    + 'DORADO LLC -- only LLC-level totals are tracked (no per-unit breakdown yet). Owns 2397 Jamaica St and the 41st fourplex. 4641 Enid Way was SOLD Aug 28, 2026 (no longer owned) -- still on Divando\'s State Farm policy pending removal (endorsement in progress). Jamaica is insured on Divando\'s State Farm policy (Dorado credits $67.40/mo back to Divando as of Aug 29, 2026, Jamaica-only; ends Dec 2026 at renewal).\n\n'
