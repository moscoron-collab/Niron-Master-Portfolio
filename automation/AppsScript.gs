...
function dashboardKnowledge() {
  return '=== DASHBOARD REFERENCE KNOWLEDGE ===\n'
    ...
    + '5070 DONALD, LLC -- 8 units = 4 duplexes (5060-5082 E Donald Ave, Denver): mortgage CBRE $13,708.00/mo (/8 = $1,713.50/unit); insurance Westfield policy 499841Y renewed Sep 20, 2026 -> Sep 20, 2027 at $14,299/yr = $1,191.58/mo (/8 = $148.95/unit), was $1,210.84/mo; SBA loan $444/mo (LLC-level); tax escrowed.\n\n'
