...
function dashboardKnowledge() {
  return '=== DASHBOARD REFERENCE KNOWLEDGE ===\n'
    ...
    + '  - Insurance: State Farm auto-draft $2,633.15/mo (actual, GROSS). This is what has drafted since May 29, 2026 (May 29, Jul 1, Jul 29); it was $2,909.98/mo before that. The policy did NOT renew - it is the same Dec 15 2025-Dec 15 2026 term - and the $276.83/mo drop is still unexplained, so the written annual ($34,630/yr across 13 units) no longer matches the draft. 12 units on the policy since 4641 Enid Way was sold + removed Aug 28, 2026. One of the 12 is Dorado-owned (2397 Jamaica St); Dorado reimburses $67.40/mo, which is NOT netted out of the $2,633.15. Agent Kevin Schult (303) 989-3847.\n'
    ...
    + '5070 DONALD, LLC -- 8 units = 4 duplexes (5060-5082 E Donald Ave, Denver): mortgage CBRE $13,494.00/mo (/8 = $1,686.75/unit; principal+interest is fixed at $11,575.20, the rest is tax escrow $1,918.80 which the Sep 2026 escrow analysis cut from $2,106.80 - Aug 2026 drafted $13,682.00); insurance Westfield policy 499841Y renewed Sep 20, 2026 -> Sep 20, 2027 at $14,299/yr = $1,191.58/mo (/8 = $148.95/unit), was $1,210.84/mo; SBA loan $444/mo (LLC-level); tax escrowed.\n\n'
    + 'DORADO LLC -- only LLC-level totals are tracked (no per-unit breakdown yet). Owns 2397 Jamaica St and the 41st fourplex. 4641 Enid Way was SOLD Aug 28, 2026 (no longer owned) and was REMOVED from Divando\'s State Farm policy the same day (endorsement processed). Jamaica is insured on Divando\'s State Farm policy (Dorado credits $67.40/mo back to Divando as of Aug 29, 2026, Jamaica-only; ends Dec 2026 at renewal).\n\n'
...
function ensurePropertyTaxTab(ss) {
  ...
  var seed = [
    ...
    ['Dorado LLC', 'CO', '4641 N ENID WAY', 'Denver', '', 2026, 0, 0, '', 'Sold - see closing statement', '132607339', 'https://www.denvergov.org/property/realproperty/taxes/0019104005000', '102105997', '2200004482189', 1954.26, 1954.26, 1756.72, '00191-04-005-000 Transaction ID #: 9646451 [SOLD Aug 28, 2026]'],
