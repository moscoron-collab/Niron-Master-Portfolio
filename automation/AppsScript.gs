...
function dashboardKnowledge() {
  return '=== DASHBOARD REFERENCE KNOWLEDGE ===\n'
    ...
    + '  - Insurance: State Farm policy ~$32,102/yr est. (~$2,699/mo est., was $34,630/yr / $2,885.83/mo-$2,909.98/mo actual across 13 units before 4641 Enid Way was sold + removed from the policy Aug 28, 2026) across 12 units now, but Divando net cashflow uses the Divando-OWNED share only = $29,677/yr ($2,473.08/mo); the difference is the one remaining Dorado-owned unit on the policy, 2397 Jamaica St (Dorado reimburses $67.40/mo as of Aug 29, 2026). Agent Kevin Schult (303) 989-3847; renews Dec 15, 2026.\n'
