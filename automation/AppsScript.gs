...
function dashboardKnowledge() {
  return '=== DASHBOARD REFERENCE KNOWLEDGE ===\n'
    ...
    + '  - Insurance: State Farm auto-draft $2,633.15/mo (actual, GROSS). The policy was RENEWED and this is the current draft (confirmed Sep 19, 2026); it was $2,909.98/mo on the prior term ($34,630/yr across 13 units). The renewal annual premium and per-property split are not on file yet. 12 units on the policy since 4641 Enid Way was sold + removed Aug 28, 2026. One of the 12 is Dorado-owned (2397 Jamaica St); Dorado reimburses $67.40/mo, which is NOT netted out of the $2,633.15. Agent Kevin Schult (303) 989-3847.\n'
