...
Farm drafted twice in July 2026, and at $2,633.15 instead of $2,909.98 — that one turned out to be a real
policy renewal, confirmed Sep 19 2026, and the reference table now carries $2,633.15). Flag it, then **wait for a second
...
|---|---|---|---|---|---|---|
| Divando | $12,199.86 — 6 `TRANSFER TO LOAN` (~15th) | $2,334.00 (1st) | State Farm **$2,633.15 (~29th)** (post-renewal; was $2,909.98 through Jun 2026) | ~$626/mo (Xcel/Aurora Water/Compost/Google — **varies, editable on dashboard**) | ACE Cloud Hosting software $288.98 (~28th, Amex) | **$2,000** |
